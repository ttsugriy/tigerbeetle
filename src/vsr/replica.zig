    ...
    return struct {
        ...
        fn on_sync_message_timeout(self: *Self) void {
            ...
            switch (self.sync_stage) {
                ...
                .request_trailers => {
                    const trailers = &self.sync_stage.request_trailers;
        ...
        fn sync_start_from_committing(self: *Self) void {
            ...
            switch (self.commit_stage) {
                .next, // (The following transition is synchronous.)
                .next_pipeline, // (The following transition is synchronous.)
                .cleanup, // (The following transition is synchronous.)
                => unreachable,
        ...
        fn sync_start_from_sync(self: *Self) void {
            ...
            switch (self.sync_stage) {
                ...
                // TODO(Zig): Inline-switch; use |stage| instead of `self.sync_stage.target().?`.
                .request_trailers,
                .request_manifest_logs,
                => {
