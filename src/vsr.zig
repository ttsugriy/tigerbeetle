...
pub const Header = extern struct {
    ...
    /// * A `request_sync_manifest` sets this to the requested doffset within the encoded Manifest.
    /// * A `request_sync_free_set` sets this to the requested doffset within the encoded FreeSet.
    /// * A `request_sync_client_sessions` sets this to the requested doffset within the encoded ClientSessions.
